...
public class Ticket extends BaseEntity {
  ...
  @Transient private short eventCode;
  @Transient private boolean isPromo;
  @Transient private StadiumSector stadiumSector;
  @Transient private float maxBackpackWeightInKg;
  ...
  public boolean equals(Object o) {
    ...
    return eventCode == ticket.eventCode
        ...
        && Float.compare(maxBackpackWeightInKg, ticket.maxBackpackWeightInKg) == 0
